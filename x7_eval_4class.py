...
# Import the dataset and model from the 4-class training script
from x7_train_4class import X7GestureDataset, GestureCNN_X7, N_CLASSES, GESTURE_FOLDERS, BATCH_SIZE
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="models/best_model_4class.pth")
