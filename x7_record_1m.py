...
# ── CONFIG ──────────────────────────────────────────────────────────────
# SDK Bin Length is ~0.0714m, Offset is -1.38m. 
# 34 bins * 0.0714 - 1.38 = 1.04 meters physical range!
RANGE_BINS = 34
RADAR_FPS  = 40   
...
def run_gesture(args, radar):
    ...
    if len(data) > 0:
        ...
        filename = f"{subject_id}_trial_{int(time.time())}.npy"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", default="gesture_dataset_1m")
