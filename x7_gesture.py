...
GESTURE_NAMES  = ["SWIPE_LR", "SWIPE_RL", "SWIPE_UD", "SWIPE_DU", "DIAG_LR_UD", "DIAG_LR_DU", "DIAG_RL_UD", "DIAG_RL_DU", "CLOCKWISE", "ANTICLOCKWISE", "INWARD_PUSH", "EMPTY"]
...
if __name__ == "__main__":
    ...
    try:
        for raw_frame in source:
            ...
            if len(complex_buffer) > X7_WINDOW_SIZE * 2: complex_buffer = complex_buffer[-X7_WINDOW_SIZE:]
            ...
            if len(complex_buffer) >= X7_WINDOW_SIZE:
                ...
                # Average the probabilities over the window instead of majority voting labels
