...
GESTURE_FOLDERS = [
    ...
    "G05_DIAG_LR_UD", "G06_DIAG_LR_DU", "G07_DIAG_RL_UD", "G08_DIAG_RL_DU",
    "G09_CLOCKWISE", "G10_ANTICLOCKWISE", "G11_INWARD_PUSH", "G12_EMPTY",
]
...
def run(args):
    ...
    try:
        ...
        for ep in range(1, args.epochs + 1):
            ...
            if val_acc > best_acc:
                best_acc = val_acc
                torch.save(model.state_dict(), os.path.join(args.out, "best_model_final.pth"))
